...
VERB: 'enter' | 'north' | 'south' | 'east' | 'west' | 'northwest' | 'northeast' | 'southwest' | 'southeast' | 'n' | 's' | 'e' | 'w' | 'nw' | 'ne' | 'sw' | 'se' | 'look' | 'l' | 'examine' | 'take' | 'drop' | 'quit' | 'q' | 'exit' | 'lick' | 'suck' | 'jump' | 'sleep' | 'rest' | 'hum' | 'sing' | 'dance' | 'dive' | 'clean' | 'clear' | 'cls' | 'inventory' | 'i' | 'kill' | 'fight' | 'wear' | 'wield' | 'talk' | 'say' | 'speak' | 'tell' |  'go' | 'move' | 'north east' | 'north west' | 'south east' | 'south west' | 'pick' ;
